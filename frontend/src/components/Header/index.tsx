  ...
  return (
    <HeaderFrame showBackground={scrollY > 45}>
      <HeaderRow>
        <Title href=".">
          <UniIcon>
            <img width={'42px'} src={darkMode ? LogoDark : Logo} alt="logo" />
          </UniIcon>
        </Title>
      </HeaderRow>
      <HeaderLinks>
        <StyledExternalLink id={`home-nav-link`} href={'https://keanuinu.finance/'}>
          <Trans>Home</Trans>
          <sup>↗</sup>
        </StyledExternalLink>
        ...
        <StyledExternalLink
          id={`charts-nav-link`}
          href={'https://www.dextools.io/app/uniswap/pair-explorer/0xfee4800067bfc9dff564d116cba4d4b16ca7b7b3'}
        >
          <Trans>Charts</Trans>
          <sup>↗</sup>
        </StyledExternalLink>
